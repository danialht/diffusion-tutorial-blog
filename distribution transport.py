...
def sample_faces(n_total=12000, mouth_frac=0.6, eyebrow_frac=0.08):
    """
...
def point_cloud_to_density(points, xlim=(-1.3, 1.3), ylim=(-1.3, 1.3), bins=220, sigma=2.0):
...
def create_animation_axes(xlim, ylim, figsize=(6.4, 6.4), facecolor="black"):
...
def render_animation(fig, update_fn, n_frames, output_path, interval=45, fps=24, dpi=160):
...
render_animation(fig_density, update_density, n_frames, "media/smiley_to_frowny_density.mp4")
...
render_animation(fig_points, update_points, n_frames, "media/smiley_to_frowny_points.mp4")